...
function main () {
  ...
  if (user == '') {
    pageInput('State your usual - or desired - code name', 'user', 'Code Name');
        ...
        api.ritm('*', 0, 'tmplt', 'prson', function(tmplt) {
          ...
          api.ritm('*', prsonTmpltId, 'prson', user, function(userItm){
            ...
            if (userId == 'not found') {
              ...
              pageChoice('Do I know you "' + user + '"?', 'newUserChoice', 'Yes', 'No')
            }
